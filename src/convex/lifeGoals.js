...
exports.getUserLifeGoals = exports.updateLifeGoal = exports.createLifeGoal = void 0;
var values_1 = require("convex/values");
var server_1 = require("./_generated/server");
var users_1 = require("./users");
exports.createLifeGoal = (0, server_1.mutation)({
    args: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ctx.db.insert("lifeGoals", __assign({ userId: user._id }, args))];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); },
});
exports.updateLifeGoal = (0, server_1.mutation)({
    args: {
        goalId: values_1.v.id("lifeGoals"),
        currentAmount: values_1.v.number(),
    },
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!user)
                        throw new Error("Not authenticated");
                    return [4 /*yield*/, ctx.db.patch(args.goalId, {
...
exports.getUserLifeGoals = (0, server_1.query)({
    args: {},
