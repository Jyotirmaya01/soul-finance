...
exports.getProfile = exports.upgradeToPremium = exports.updateProfile = void 0;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (args.newsletterSubscribed !== undefined)
                        updates.newsletterSubscribed = args.newsletterSubscribed;
                    return [4 /*yield*/, ctx.db.patch(user._id, updates)];
                case 2:
                    _a.sent();
...
exports.upgradeToPremium = (0, server_1.mutation)({
    args: {},
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!user)
                        throw new Error("Not authenticated");
                    return [4 /*yield*/, ctx.db.patch(user._id, { isPremium: true })];
                case 2:
                    _a.sent();
                    return [2 /*return*/, { success: true }];
            }
...
exports.getProfile = (0, server_1.query)({
    args: {},
    handler: function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
