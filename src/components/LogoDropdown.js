...
function LogoDropdown() {
    var _this = this;
    var _a = (0, use_auth_1.useAuth)(), isAuthenticated = _a.isAuthenticated, signOut = _a.signOut;
    ...
    return (<dropdown_menu_1.DropdownMenu>
      <dropdown_menu_1.DropdownMenuTrigger asChild>
        <button_1.Button variant="ghost" size="icon" className="h-10 w-10">
      ...
      <dropdown_menu_1.DropdownMenuContent align="start" className="w-48">
        <dropdown_menu_1.DropdownMenuItem onClick={handleGoHome} className="cursor-pointer">
