...
const ALL_ACHIEVEMENTS = [
  // Beginner Achievements (25-50 points)
  {
    type: "quiz_completed",
  ...
  // Intermediate Achievements (50-150 points)
  {
    type: "mood_streak_7",
    title: "Week Warrior",
  ...
  // Advanced Achievements (200-500 points)
  {
    type: "mood_streak_60",
    title: "Consistency King",
    description: "Track your mood for 60 days straight",
    icon: "⚡",
    points: 250,
  },
  {
    type: "mood_streak_90",
    title: "Habit Master",
    description: "Track your mood for 90 days straight",
    icon: "🌟",
    points: 350,
  },
  {
    type: "mood_streak_180",
    title: "Half Year Hero",
    description: "Track your mood for 180 days straight",
    icon: "🎖️",
    points: 500,
  },
  {
    type: "mood_streak_365",
    title: "Year-Long Legend",
    description: "Track your mood for 365 days straight",
    icon: "🏅",
    points: 1000,
  },
  {
    type: "goals_completed_3",
    title: "Triple Threat",
    description: "Complete 3 life goals",
    icon: "🎯",
    points: 250,
  },
  {
    type: "goals_completed_5",
    title: "Goal Dominator",
    description: "Complete 5 life goals",
    icon: "🏆",
    points: 400,
  },
  {
    type: "goals_completed_10",
  ...
  },
  {
    type: "portfolio_25k",
    title: "25K Elite",
    description: "Reach $25,000 in portfolio value",
    icon: "💰",
    points: 300,
  },
  {
    type: "portfolio_50k",
    title: "50K Master",
    description: "Reach $50,000 in portfolio value",
    icon: "💵",
    points: 500,
  },
  {
  ...
  {
    type: "diverse_portfolio_5",
    title: "Diversification Starter",
    description: "Hold 5 different investments",
    icon: "📊",
    points: 150,
  },
  {
    type: "diverse_portfolio_10",
    title: "Portfolio Architect",
    description: "Hold 10 different investments",
    icon: "📈",
    points: 300,
  },
  {
    type: "diverse_portfolio_15",
    title: "Investment Maestro",
    description: "Hold 15+ different investments",
    icon: "🎼",
    points: 500,
  },
  
  // Elite Achievements (500-1500 points)
  {
    type: "circles_created_3",
  ...
  {
    type: "calculator_master",
    title: "Calculator Master",
    description: "Use all 9 financial calculators",
    icon: "🧮",
    points: 200,
  },
  {
    type: "astrology_explorer",
    title: "Cosmic Investor",
    description: "Check financial astrology 10 times",
    icon: "🔮",
    points: 150,
  },
  {
  ...
  },
  {
    type: "early_adopter",
    title: "Early Adopter",
    description: "Join Soul Finance in the first 1000 users",
    icon: "🚀",
    points: 300,
  },
  {
  ...
  {
    type: "soul_finance_legend",
    title: "Soul Finance Legend",
